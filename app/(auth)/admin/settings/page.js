  ...
  const handlePasswordUpdate = async (e) => {
    ...
    try {
      ...
      if (error.code === 'auth/wrong-password') {
        toast.error('Incorrect old password. Please try again.', { id: toastId });
      } else {
    ...
    <div className="flex min-h-screen font-sans bg-[#f8f8f8]">
        ...
        <div className="flex justify-center">
          <div className="w-full max-w-[1190px] flex flex-col md:flex-row gap-6">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="w-full h-auto md:h-[140px] gap-4 md:gap-[43px] rounded-xl p-4 md:p-5 bg-white shadow-sm border border-gray-200 flex flex-col md:flex-row items-center justify-between mb-4 md:mb-6">
                <div className="flex items-center gap-3 md:gap-4 w-full md:w-auto">
                  ...
                  <div>
                    ...
                    <p className="text-md md:text-lg text-gray-500">User</p>
                  </div>
                </div>
               <button
      ...
      {showPasswordModal && (
        <div className="fixed inset-0 z-50 bg-[#00000099] flex items-center justify-center p-4">
          <div className="w-full max-w-[660px] bg-white rounded-xl p-6 md:p-8 flex flex-col gap-6">
            <h2 className="text-xl font-bold text-gray-800">Change Password</h2>
            <form onSubmit={handlePasswordUpdate}>
              <div className="flex flex-col gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Old Password</label>
                  <input type="password" value={oldPassword} onChange={(e) => setOldPassword(e.target.value)} placeholder="Enter your current password" required className="w-full px-4 py-2 rounded-md border border-gray-400" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">New Password</label>
                  <input type="password" value={newPassword} onChange={handlePasswordChange} placeholder="Enter your new password" required className="w-full px-4 py-2 rounded-md border border-gray-400" />
                ...
                <div>
                  ...
                  <input type="password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} placeholder="Confirm your new password" required className="w-full px-4 py-2 rounded-md border border-gray-400" />
                </div>
              </div>
              <div className="flex justify-between mt-6 gap-3">
                <button type="button" onClick={() => setShowPasswordModal(false)} className="w-full md:w-auto flex-1 px-4 py-2 rounded-lg bg-gray-200 text-gray-700 hover:bg-gray-300">
                  Cancel
                </button>
                <button type="submit" className="w-full md:w-auto flex-1 px-4 py-2 rounded-lg bg-[#5D5FEF] text-white hover:bg-[#4b4df0]">
                  Update Password
                </button>
              </div>
            </form>
      ...
      {showUploadModal && (
        <div className="fixed inset-0 z-50 bg-[#00000099] flex items-center justify-center p-4">
          ...
          <div className="w-full max-w-[660px] h-auto max-h-[90vh] bg-white rounded-[12px] p-6 md:p-[32px] flex flex-col gap-6 md:gap-[40px] overflow-y-auto">
            ...
            <label 
              htmlFor="file-upload" 
              className="relative w-full h-[151px] border-2 border-dashed border-gray-300 rounded-[8px] flex flex-col items-center justify-center p-4 cursor-pointer hover:bg-gray-50 transition-colors"
            >
              {imagePreview ? (
                <Image 
                  src={imagePreview} 
            ...
            <div className="flex flex-col md:flex-row justify-between w-full gap-3">
              ...
              <button
                ...
                disabled={uploading}
                className="w-full md:w-[288px] h-[48px] px-[10px] py-[10px] rounded-[8px] bg-[#5D5FEF] text-white hover:bg-[#4b4df0] transition disabled:bg-gray-400 disabled:cursor-not-allowed"
              >
