...
//         {/* <header className="fixed top-0 inset-x-0 z-50 bg-white shadow-sm md:pl-64"> */}
...
//           className="p-2 text-gray-600 rounded-md md:hidden focus:outline-none focus:ring-2 focus:ring-indigo-500"
//         >
//           <svg
