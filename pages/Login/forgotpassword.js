  ...
  return (
   ...
   <div className="w-full max-w-lg bg-white p-10 rounded-xl shadow-2xl relative z-10">
      ...
      {/* Forgot Password Card */}
        ...
        {/* Heading */}
        <h2 className="text-center text-2xl font-bold text-black mb-1">Forgot Password</h2>
        <p className="text-center text-sm text-gray-600 mb-6">
          No worries! Enter your email, and we’ll send you a verification <br />code to reset it.
        </p>
