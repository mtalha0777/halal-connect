  ...
  return (
     ...
     <div className="w-full max-w-lg bg-white p-10 rounded-xl shadow-2xl relative z-10">
        ...
        <form>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#5D5FEF] placeholder:text-gray-400"
            />
          </div>
        ...
        <div className="flex gap-4">
          ...
          >
            <Image src="/assets/google-logo.png" alt="Google" width={20} height={20} className="mr-2" />
          ...
          <button
            ...
            className="flex items-center justify-center w-1/2 py-2 border border-gray-300 rounded-md bg-white hover:bg-gray-50 transition"
          >
            <Image src="/assets/fb-logo.png" alt="Facebook" width={20} height={20} className="mr-2" />
        ...
        <p className="text-center text-sm mt-6">
          ...
          <a href="/Login/login" className="font-semibold hover:underline text-[#5D5FEF]">
            Sign in
          </a>
        </p>
      </div>
