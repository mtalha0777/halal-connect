          ...
          {reportedProfiles.map((profile) => (
            ...
            >
              ...
              <div className="text-sm text-gray-600 space-y-1">
                ...
                <p>
                  <strong>Reported By:</strong> {profile.reportedBy}
                </p>
                <p>
              ...
              <div className="flex justify-end pt-3 border-t border-gray-200">
                <Link
                  href={`/management/userDetails/${profile.id}`}
                  className="px-4 py-2 text-xs font-medium text-purple-600 bg-purple-100 rounded-lg hover:bg-purple-200"
                >
                  View Details
                </Link>
              </div>
...
ContentModeration.getLayout = function getLayout(page) {
