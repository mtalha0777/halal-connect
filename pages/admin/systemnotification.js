...
const notificationDataInitial = [
{
  ...
  },
  {
    ...
    description: 'Someone just liked your profile! Check them out now and start a conversation.',
    status: 'Inactive',
  },
  {
    date: '01-14-2025',
...
export default function SystemNotification() {
  const [notificationData, setNotificationData] = useState(notificationDataInitial);
  const [popup, setPopup] = useState({ visible: false, item: null, index: null });
  ...
  return (
   ...
   <div className="fixed inset-0 bg-[#00000099] flex items-center justify-center z-50">
    ...
    <div className="bg-white rounded-[12px] w-[660px] h-[484px] p-[32px] flex flex-col gap-[40px]">
      <h3 className="text-xl font-semibold text-left">Push Notification</h3>

      <div className="space-y-4">
        <div>
         <label className="block text-sm font-medium mb-1 text-[#00000066]">Notification Name</label>
        ...
        <div>
         <label className="block text-sm font-medium mb-1 text-[#00000066]">Description</label>
