...
// import BlockedDetails from "../contentdetails/blockdetails";
...
//                 </span>
//               </td>
//               <td className="text-center relative whitespace-nowrap" ref={actionMenuRef}>
//                 <button
//                   onClick={() => setOpenMenu(openMenu === i ? null : i)}
//                   className="text-lg text-gray-600"
//                 >
//                   <Image src="/assets/dots.svg" alt="Actions" width={20} height={20} />
//                 </button>
// {/* {openMenu === i && (
...
//         router.push(
//           actionType === "blocked"
//             ? "/contentdetails/block-details"
//             : "/contentdetails/view-details"
//         )
//       }
//       className="flex items-center gap-2 w-full px-4 py-2 text-left text-sm hover:bg-gray-100 text-gray-700"
//     >
...
//     <Image src="/assets/unblock.svg" alt="Unblock" width={20} height={20} />
//     Unblock
//   </button>
// )}
...
//   <>
//     <button className="flex items-center gap-2 w-full px-4 py-2 text-left text-sm hover:bg-gray-100 text-gray-700">
//       <Image src="/assets/unblock.svg" alt="Suspend" width={20} height={20} />
//       Temporary Suspend
//     </button>
//     <button className="flex items-center gap-2 w-full px-4 py-2 text-left text-sm hover:bg-gray-100 text-gray-700">
